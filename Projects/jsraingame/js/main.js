window.addEventListener("load", function(event) {
    ...
    var render = function() {
      ...
      for(let i = 0; i < game.world.rain.length; i++){
        display.drawRectangle(game.world.rain[i].x, game.world.rain[i].y, game.world.rain[i].width, game.world.rain[i].height, game.world.rain[i].color);
      }
    ...
    var update = function() {
      ...
      if (((Math.floor(engine.time/1000) % 2)== 0) && game.world.dispDifficulty < Math.floor(engine.time/1000)/2){
